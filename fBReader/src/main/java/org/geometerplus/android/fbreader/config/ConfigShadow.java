...
import org.geometerplus.android.fbreader.TranslateAction;
...
//		}
    ...
    @Override
    public int getSpecialIntValue(String name, int defaultV) {
        return myContext.getSharedPreferences("fbreader.ui", 0).getInt(TranslateAction.TRANS_COUNT, defaultV);
    }

    @Override
    public void setSpecialIntValue(String name, int value) {
        myContext.getSharedPreferences("fbreader.ui", Context.MODE_PRIVATE).edit()
