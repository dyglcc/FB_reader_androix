...
//				FBReaderIntents.internalIntent(FBReaderIntents.Action.LIBRARY_SERVICE),
            ...
            Log.e(TAG, "bindToService: " + result);
//            handler.post(onBindAction);
            if (result) {
                myContext = context;
            }
            return result;
    ...
    public synchronized void unbind() {
        if (myContext != null && myInterface != null) {
            try {
                ...
                Log.e("receiver_leak", "onServiceConnected: unbind receiver");
...
//            Config.Instance().runOnConnect(a);
        ...
        if (myContext != null) {
            ...
            Log.e("receiver_leak", "onServiceConnected: bind receiver");
        }
    }
